...
QSAFE is a disaster-assistance project for Nepal that combines a lightweight frontend UI, a Node.js backend API, and optional offline NLP training and inference.
